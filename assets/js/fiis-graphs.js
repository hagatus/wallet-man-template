(function() {
    console.log('fiis-graphs.js ready');
    ...
    function fiiCompositionGraph() {
        const element = document.getElementById('fii-composition-graph')
        if (element === null) {
            console.error("Element is null, graph not created");
            return void(0);
        }
    ...
    function fiiEvolutionGraph() {
        const element = document.getElementById('fii-evolution-graph')
        if (element === null) {
            console.error("Element is null, graph not created");
            return void(0);
        }
